...
const SeminarsSection: React.FC = () => (
  ...
  <p><strong>Roman Dmytryshyn </strong></p>
  <p> Vasyl Stefanyk Carpathian National University, Ukraine</p>
